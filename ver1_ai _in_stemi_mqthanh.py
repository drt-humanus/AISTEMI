# streamlit run "D:\NC mortality NMCT ĐHYD\app\anngrace\ver1_ai _in_stemi_mqthanh.py"
...
def calculate_risk():
    ...
    ann_model = get_pickle_data()
    # Store the models prediction in a variable
    prediction = ann_model.predict_proba(user_input)
    ...
    st.write('Mô hình ANN')
    st.write('Độ chính xác của chẩn đoán: 87.0%' + ' ' + '('+  'AUC: 0.77)')
